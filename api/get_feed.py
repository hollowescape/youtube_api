...
def getnewfeeds():
    ...
    for apikey in apikeys:
        try:
            ...
            # The predefined query is 'netflix' here, calling an instance of the same
            
            req = youtube.search().list(q="netflix",part="snippet", order="date",
            ...
            for obj in response['items']:
                ...
                Feeds.objects.create(title=title, description=description,
